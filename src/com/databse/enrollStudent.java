...
public class enrollStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Enter Valid Student Details to Enroll");
        ...
        resultText.setFont(new java.awt.Font("Comic Sans MS", 1, 17)); // NOI18N
...
//        int cnum = Integer.parseInt(classId);
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call Project_Two.enroll_student_to_class(?,?,?)}");
            //set the in parameter (the first parameter)

            System.out.println("Department code " + bNumber);
            System.out.println("Course Number " + classId);
